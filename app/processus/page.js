...
const [selectedProcessus, setSelectedProcessus] = useState(
  inverseMap?.[0] || 'Ressources Humaines'
);
...
>
  ...
  <tr>
    ...
    <th className="border p-3 text-left">Propriétaire</th>
    <th className="border p-3 text-left">D.P</th>
    <th className="border p-3 text-left">Classification</th>
    <th className="border p-3 text-left">Risque</th>
    <th className="border p-3 text-left">Date</th>
        <th className="border p-3 text-left">Fiche</th>
